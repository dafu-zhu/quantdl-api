...
class TestS3Credentials:
    ...
    def test_s3_explicit_credentials(self) -> None:
        """Test StorageBackend accepts explicit credentials."""
    ...
    def test_s3_no_credentials_local_mode(self) -> None:
        """Test StorageBackend works without credentials in local mode."""
        storage = StorageBackend(local_path="/tmp/test")
...
class TestPathResolution:
    ...
    def test_resolve_path_s3(self) -> None:
        ...
        storage = StorageBackend(bucket="my-bucket")
        resolved = storage._resolve_path("/data/test.parquet")
...
class TestS3RequestCounter:
    ...
    def test_storage_has_counter(self, local_storage: StorageBackend) -> None:
        """Test StorageBackend has request counter."""
